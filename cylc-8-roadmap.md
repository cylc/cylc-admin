...
1. __User Authorization__ (which users can do what to a suite?)
...
1. __Job-to-Suite Communications__ (“job authentication” for status messages etc.)
...
1. __Backward Compatibility / Transition Period__
...
1. __Packaging__ - proper `setup.py`-based installation
...
![cylc-7 architecture](gfx/foo-0.png "cylc-7 architecture")
...
![Possible new architecture](gfx/foo1.png "Possible new architecture")

__Figure 2__: Proposed new architecture

![Possible client-suite interaction](gfx/foo-2.png "Possible new client-suite interaction")

__Figure 3__: possible client-suite interaction, in the new architecture

![Possible job-suite interaction](gfx/foo-3.png "Possible new job-suite interaction")
